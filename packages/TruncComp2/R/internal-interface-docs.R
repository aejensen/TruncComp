...
#'
#' ### `trunc_comp_core(y, a, r, method, conf.level = 0.95, init = NULL,
#' adjust_data = NULL, adjust_formula = NULL, atom = NULL, call = NULL)`
#'
...
#'   init = NULL, data = NULL, adjust = NULL, atom = NULL, call = NULL
#' )
...
#' optional standardized data, the fitted atom, and the matched call.
#'
#' ### `new_failed_trunc_comp_fit(...)`
#'
...
#'
#' Developer-facing documentation for the utilities that access bundled example
#' data and build reproducible simulated datasets for tests, examples, and
#' validation scripts.
#'
#' @name trunccomp2-simulation-helpers
#' @title Internal example-loading and simulation helpers
#' @description
#' These helpers provide compact wrappers around the public simulation
#' interface and the package datasets used by the deprecated example loaders.
...
#' atom = 0)`
#'
#' Legacy convenience wrapper around [simulate_truncated_data()]. `mu0` and `mu1`
...
#' as [simulate_truncated_data()]. Its role is to preserve a compact simulation
#' shortcut used in older scripts and notes.
#'
#' @seealso [simulate_truncated_data()], [load_trunc_comp2_example()],
