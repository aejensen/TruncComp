...
hist(subset(d, !d$allocation)$dawols28, 10, xlim=c(0,30),
     ...
     cex.axis=1.2, cex.main=1.5, cex.lab=1.3, ylab="",
...
image(sCI$muDelta, sCI$logORdelta, sCI$surface,
     ...
     ylab="log OR",
     cex.axis=1.2, cex.main=1.5, cex.lab=1.3)
