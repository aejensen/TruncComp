test_that("Successful Bayesian fits return the expected object shape", {
  ...
  expect_true(all(TruncComp:::bayes_parameter_names("all") %in% names(fit$draws)))
...
test_that("Bounded Bayesian fits return expected settings and draw names", {
  ...
  expect_true(all(TruncComp:::bayes_parameter_names("all") %in% names(continuous_fit$draws)))
  expect_true(all(TruncComp:::bayes_parameter_names("all") %in% names(score_fit$draws)))
