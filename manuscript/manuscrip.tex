...
\[
  ...
  =0
\]
for any Bernoulli score component $S_A$. The two restrictions are therefore asymptotically block-orthogonal, and the sum in Equation~(\ref{eq:LRT_SP_total}) has the $\chi^2_2$ null limit.
\end{proof}
